...
entry(
    index = 1012,
    label = "C4H10O-10 + OH <=> H2O + C4H9O-10",
    degeneracy = 1,
    ...
    longDesc = 
u"""
Taken from entry: Evans-Polyani type correlations E_iso = E_n + 0.4 (BDE_n - BdE_iso)to get
...
entry(
    index = 1013,
    label = "C4H10O-12 + OH <=> H2O + C4H9O-12",
    degeneracy = 1,
...
entry(
    ...
    longDesc = 
u"""
Taken from entry: Quantum chemistry calculations CBS-QB3 calculation with 1-d rotor treatment at
...
entry(
    index = 1021,
    label = "C4H10O-12 + CH3 <=> CH4 + C4H9O-12",
    degeneracy = 1,
...
entry(
    index = 1023,
    label = "C4H10O-11 + C2H3 <=> C2H4 + C4H9O-11",
    degeneracy = 1,
...
entry(
    index = 1024,
    label = "C4H10O-10 + C2H3 <=> C2H4 + C4H9O-10",
    degeneracy = 1,
...
entry(
    index = 1025,
    label = "C4H10O-12 + C2H3 <=> C2H4 + C4H9O-12",
    degeneracy = 1,
...
entry(
    index = 1026,
    label = "H2O2 + C4H9O-11 <=> C4H10O-11 + HO2",
    degeneracy = 1,
...
entry(
    index = 1027,
    label = "H2O2 + C4H9O-10 <=> C4H10O-10 + HO2",
    degeneracy = 1,
...
entry(
    index = 1028,
    label = "H2O2 + C4H9O-12 <=> C4H10O-12 + HO2",
    degeneracy = 1,
